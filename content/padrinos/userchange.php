...
<table>
	...
	$user = isset($_GET["user"]) ? $_GET["user"] : '';
		...
		if (isset($_POST['modificar']))
		{
			...
			$sql = "UPDATE `padrino` SET nombre='".$_POST['nombre_user']."' WHERE DNI='".$_POST['dni_user']."'";
                        
			$res = mysqli_query($conexion_bd, $sql);
                                          
                        
                        $sql = "UPDATE `padrino` SET correo='".$_POST['email_user']."' WHERE DNI='".$_POST['dni_user']."'";

                        
			$res = mysqli_query($conexion_bd, $sql);
                        
                        $sql = "UPDATE `padrino` SET direccion='".$_POST['direccion_user']."' WHERE DNI='".$_POST['dni_user']."'";

                        
			$res = mysqli_query($conexion_bd, $sql);
                        
                        $sql = "UPDATE `padrino` SET telefono='".$_POST['telefono_user']."' WHERE DNI='".$_POST['dni_user']."'";
	...
	<tbody>
		...
		<?php
			...
			$sql = "SELECT * FROM padrino WHERE DNI='".$user."'";
