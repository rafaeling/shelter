<form id="formulario_usuario" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
	...
	<?php
		...
		if (isset($_POST['insertar']))
		{
			...
			$sql = "INSERT INTO `shelter`.`padrino` (`DNI`, `nombre`, `correo`, `direccion`, `telefono`) VALUES ('".$_POST['dni_user']."', '".$_POST['nombre_user']."', '".$_POST['email_user']."', '".$_POST['direccion_user']."', '".$_POST['telefono_user']."');";

			$res = mysqli_query($conexion_bd, $sql);

			if($res == 1)
			{
				header('Location: index.php?t=padrino');
			}else
			{
