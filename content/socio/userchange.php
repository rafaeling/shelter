...
<table>
	...
	$user = isset($_GET["user"]) ? $_GET["user"] : '';
		...
		if (isset($_POST['modificar']))
		{
			...
			$sql = "UPDATE `socio` SET nombre='".$_POST['nombre_user']."' WHERE DNI='".$_POST['dni_user']."'";
                        
			$res = mysqli_query($conexion_bd, $sql);
                                          
                        
                        $sql = "UPDATE `socio` SET correo='".$_POST['email_user']."' WHERE DNI='".$_POST['dni_user']."'";

                        
			$res = mysqli_query($conexion_bd, $sql);
                        
                        $sql = "UPDATE `socio` SET direccion='".$_POST['direccion_user']."' WHERE DNI='".$_POST['dni_user']."'";

                        
			$res = mysqli_query($conexion_bd, $sql);
                        
                        $sql = "UPDATE `socio` SET telefono='".$_POST['telefono_user']."' WHERE DNI='".$_POST['dni_user']."'";
	...
	<tbody>
		...
		<?php
			...
			$sql = "SELECT * FROM socio WHERE DNI='".$user."'";
